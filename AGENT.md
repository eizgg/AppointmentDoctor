# Turno Fácil — Documentación del Proyecto

## Descripción
Sistema de gestión de turnos médicos. Webapp mobile-first pensada para que pacientes gestionen sus citas con profesionales de salud.
